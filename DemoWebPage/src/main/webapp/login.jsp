		...
		<div class="row w-100 m-0">
			<div class="col-12 col-sm-7">
				<div class="card border-0 bg-light">
					<img src="${pageContext.request.contextPath}/img/login.svg" alt="" class="card-img-top img-shadow"
				...
				<div class="card shadow">
					<div class="card-header bg-white">
						<div class="d-flex flex-column justify-content-center align-items-center">
							...
							<h5 class="text-sm text-muted mb-0">Login</h5>
						</div>
					</div>
					<div class="card-body p-4 mt-4">
						<form action="login" method="post">
							...
							<div class="d-flex justify-content-between align-items-center"
								...
								<a type="button" href="${pageContext.request.contextPath}/register.jsp" class="btn btn-secondary">Create Account</a>
